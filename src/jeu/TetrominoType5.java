...
public class TetrominoType5 extends Tetromino{

	/**
	 * Constructeur de tétromino type 5
	 ...
	 */
	public TetrominoType5(int position,int tailleCase) {
		super(5, position);
		...
		this.tab[3][2][1]=new ObjetGraphique(3,2,tailleCase,couleur);
		...
		this.tab[1][0][2]=new ObjetGraphique(1,0,tailleCase,0);
		this.tab[2][0][2]=new ObjetGraphique(2,0,tailleCase,0);
		this.tab[3][0][2]=new ObjetGraphique(3,0,tailleCase,couleur);
		
		this.tab[0][1][2]=new ObjetGraphique(0,1,tailleCase,0);
		this.tab[1][1][2]=new ObjetGraphique(1,1,tailleCase,0);
		this.tab[2][1][2]=new ObjetGraphique(2,1,tailleCase,couleur);
		this.tab[3][1][2]=new ObjetGraphique(3,1,tailleCase,couleur);
		...
		this.tab[3][2][2]=new ObjetGraphique(3,2,tailleCase,couleur);
