...
public class TetrominoType3 extends Tetromino{

	/**
	 * Constructeur de tétromino type 3
	...
	public TetrominoType3(int position,int tailleCase) {
		...
		this.tab[2][1][0]=new ObjetGraphique(2,1,tailleCase,0);
		this.tab[3][1][0]=new ObjetGraphique(3,1,tailleCase,0);
		
		this.tab[0][2][0]=new ObjetGraphique(0,2,tailleCase,0);
		this.tab[1][2][0]=new ObjetGraphique(1,2,tailleCase,couleur);
		...
		this.tab[2][1][2]=new ObjetGraphique(2,1,tailleCase,0);
		this.tab[3][1][2]=new ObjetGraphique(3,1,tailleCase,0);
		
		this.tab[0][2][2]=new ObjetGraphique(0,2,tailleCase,0);
		this.tab[1][2][2]=new ObjetGraphique(1,2,tailleCase,couleur);
