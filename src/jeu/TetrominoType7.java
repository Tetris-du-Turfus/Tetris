...
public class TetrominoType7 extends Tetromino{

	/**
	 * Constructeur de tétromino type 7
	 ...
	 */
	public TetrominoType7(int position,int tailleCase) {
		super(7, position);
		...
		this.tab[1][0][0]=new ObjetGraphique(1,0,tailleCase,0);
		...
		this.tab[1][1][0]=new ObjetGraphique(1,1,tailleCase,0);
		...
		this.tab[3][2][3]=new ObjetGraphique(3,2,tailleCase,couleur);
